...
# TARGET_DIR = os.path.join(os.getcwd(), "data/gift_data.csv")
TARGET_DIR = "/home/siyun/ephemeral/code/recboleeee/amazon/amazon/"
os.makedirs(TARGET_DIR, exist_ok=True)
print("Creating New Data for RecBole...")

# === movie.inter 생성
# train_ratings.csv를 받아서 movie.inter로 생성
FILE = '/home/siyun/ephemeral/lightgcn/data/fashion_filter_5.csv'
TARGET_NAME = 'amazon.inter'

df = pd.read_csv(FILE)
df = df[['user_id', 'item_id', 'ratings']] 
df = df.rename(
    columns = {
...
df.to_csv(TARGET_DIR + TARGET_NAME, index=False, sep='\t')
